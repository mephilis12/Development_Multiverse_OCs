...
public class ModItems {
    ...
    public static final Item RUBY_UPGRADE = registerItem("ruby_upgrade", new Item(new Item.Settings()));
    public static final Item COBALT_UPGRADE = registerItem("cobalt_upgrade", new Item(new Item.Settings()));
    ...
    public static final Item COBALT_BATTLEAXE = registerItem("cobalt_battleaxe"
            , new SwordItem(ModToolMaterial.COBALT,6,-3.5F, new Item.Settings()));
    public static final Item COBALT_CLAYMORE = registerItem("cobalt_claymore"
            , new SwordItem(ModToolMaterial.COBALT,2,-2.5F, new Item.Settings()));
    public static final Item COBALT_HAMMER = registerItem("cobalt_hammer"
            , new HammerItem(ModToolMaterial.COBALT,8,-3.75F, new Item.Settings()));
    public static final Item COBALT_MORNINGSTAR = registerItem("cobalt_morningstar"
            , new SwordItem(ModToolMaterial.COBALT,1,-1.5F, new Item.Settings()));
    public static final Item COBALT_SCYTHE = registerItem("cobalt_scythe"
            , new net.mephilis.devocs.item.ScytheItem(ModToolMaterial.COBALT,0,-1F, new Item.Settings()));
    public static final Item RUBY_BATTLEAXE = registerItem("ruby_battleaxe"
            , new SwordItem(ModToolMaterial.RUBY,5,-3F, new Item.Settings()));
    public static final Item RUBY_CLAYMORE = registerItem("ruby_claymore"
            , new SwordItem(ModToolMaterial.RUBY,2,-2.5F, new Item.Settings()));
    public static final Item RUBY_HAMMER = registerItem("ruby_hammer"
            , new HammerItem(ModToolMaterial.RUBY,7,-3F, new Item.Settings()));
    public static final Item RUBY_MORNINGSTAR = registerItem("ruby_morningstar"
            , new SwordItem(ModToolMaterial.RUBY,-1,-1F, new Item.Settings()));
    public static final Item RUBY_SCYTHE = registerItem("ruby_scythe"
            , new net.mephilis.devocs.item.ScytheItem(ModToolMaterial.RUBY,-1,-1F, new Item.Settings()));
    public static final Item TRUSTY = registerItem("trusty"
            , new SwordItem(ModToolMaterial.SPECIAL,4,-2.4F, new Item.Settings()));
    public static final Item MOSSY_SCYTHE = registerItem("mossy_scythe"
            , new net.mephilis.devocs.item.ScytheItem(ModToolMaterial.SPECIAL,2,-1, new Item.Settings()));
    ...
    public static final Item MILKSHAKE = registerItem("milkshake", new MilkshakeItem(new Item.Settings().food(ModFoodComponents.MILKSHAKE).maxCount(1)));
